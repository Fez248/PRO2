...
Definition at line 195 of file Cluster.\+cc.
...
Definition at line 87 of file Cluster.\+cc.


\begin{DoxyCode}{0}
\DoxyCodeLine{87                                                                     \{}
\DoxyCodeLine{88     \mbox{\hyperlink{Cluster_8cc_aca9bff578e68b2d3af09b6bfaa7bd68d}{clus\_it}} it = \mbox{\hyperlink{classCluster_aea7f1c755c1fb744008e344a3692dafb}{conj}}.find(x);}
\DoxyCodeLine{89 }
\DoxyCodeLine{90     \textcolor{keywordflow}{if} (it == \mbox{\hyperlink{classCluster_aea7f1c755c1fb744008e344a3692dafb}{conj}}.end()) \textcolor{keywordflow}{return} 101;}
\DoxyCodeLine{91     \textcolor{keywordflow}{return} it-\/>second.add\_process\_cpu(identity, memory, time);}
\DoxyCodeLine{92 \}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{110                       \{}
\DoxyCodeLine{111     \mbox{\hyperlink{Cluster_8cc_aca9bff578e68b2d3af09b6bfaa7bd68d}{clus\_it}} itf = \mbox{\hyperlink{classCluster_aea7f1c755c1fb744008e344a3692dafb}{conj}}.end();}
\DoxyCodeLine{112 }
\DoxyCodeLine{113     \textcolor{keywordflow}{for} (\mbox{\hyperlink{Cluster_8cc_aca9bff578e68b2d3af09b6bfaa7bd68d}{clus\_it}} it = \mbox{\hyperlink{classCluster_aea7f1c755c1fb744008e344a3692dafb}{conj}}.begin(); it != itf; ++it) it-\/>second.advance(t);}
\DoxyCodeLine{114 \}}
...
Definition at line 94 of file Cluster.\+cc.


\begin{DoxyCode}{0}
\DoxyCodeLine{94                                               \{}
\DoxyCodeLine{95     \mbox{\hyperlink{Cluster_8cc_aca9bff578e68b2d3af09b6bfaa7bd68d}{clus\_it}} it = \mbox{\hyperlink{classCluster_aea7f1c755c1fb744008e344a3692dafb}{conj}}.find(x);}
\DoxyCodeLine{96 }
\DoxyCodeLine{97     \textcolor{keywordflow}{if} (it == \mbox{\hyperlink{classCluster_aea7f1c755c1fb744008e344a3692dafb}{conj}}.end()) \textcolor{keywordflow}{return} 101;}
\DoxyCodeLine{98     \textcolor{keywordtype}{int} back = 0;}
\DoxyCodeLine{99     \textcolor{keywordflow}{return} it-\/>second.remove\_process\_cpu(identity, back);}
\DoxyCodeLine{100 \}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{126                   \{}
\DoxyCodeLine{127     \mbox{\hyperlink{Cluster_8cc_aca9bff578e68b2d3af09b6bfaa7bd68d}{clus\_it}} itf = \mbox{\hyperlink{classCluster_aea7f1c755c1fb744008e344a3692dafb}{conj}}.end();}
\DoxyCodeLine{128     \textcolor{keywordflow}{for} (\mbox{\hyperlink{Cluster_8cc_aca9bff578e68b2d3af09b6bfaa7bd68d}{clus\_it}} it = \mbox{\hyperlink{classCluster_aea7f1c755c1fb744008e344a3692dafb}{conj}}.begin(); it != itf; ++it) \{}
\DoxyCodeLine{129         \textcolor{keywordflow}{if} (it-\/>second.what\_ffree() <= it-\/>second.what\_mema()) \{}
\DoxyCodeLine{130             it-\/>second.compactar();}
\DoxyCodeLine{131         \}}
\DoxyCodeLine{132     \}}
\DoxyCodeLine{133 \}   }
...
\begin{DoxyCode}{0}
\DoxyCodeLine{116                           \{}
\DoxyCodeLine{117     \mbox{\hyperlink{Cluster_8cc_aca9bff578e68b2d3af09b6bfaa7bd68d}{clus\_it}} it = \mbox{\hyperlink{classCluster_aea7f1c755c1fb744008e344a3692dafb}{conj}}.lower\_bound(x);}
\DoxyCodeLine{118 }
\DoxyCodeLine{119     \textcolor{keywordflow}{if} (it == \mbox{\hyperlink{classCluster_aea7f1c755c1fb744008e344a3692dafb}{conj}}.end() or it-\/>first != x) \textcolor{keywordflow}{return} \textcolor{keyword}{false};}
\DoxyCodeLine{120     \textcolor{keywordflow}{if} (it-\/>second.what\_ffree() <= it-\/>second.what\_mema()) \{}
\DoxyCodeLine{121         it-\/>second.compactar();}
\DoxyCodeLine{122     \}}
...
Definition at line 163 of file Cluster.\+cc.


\begin{DoxyCode}{0}
\DoxyCodeLine{163                                                                               \{}
\DoxyCodeLine{164     \textcolor{keywordtype}{int} no\_space, free\_space;}
\DoxyCodeLine{165     no\_space = free\_space = -\/1;}
\DoxyCodeLine{166     \textcolor{keywordflow}{if} (!can.empty()) \{}
\DoxyCodeLine{167         queue<BinTree<string>> need\_visit;}
\DoxyCodeLine{168         need\_visit.push(can);}
\DoxyCodeLine{169 }
\DoxyCodeLine{170         \textcolor{keywordflow}{while} (!need\_visit.empty()) \{}
\DoxyCodeLine{171             BinTree<string> ls, rs;}
\DoxyCodeLine{172             ls = need\_visit.front().left();}
\DoxyCodeLine{173             rs = need\_visit.front().right();}
\DoxyCodeLine{174             \textcolor{keywordtype}{string} x = need\_visit.front().value();}
\DoxyCodeLine{175             need\_visit.pop();}
\DoxyCodeLine{176 }
\DoxyCodeLine{177             \mbox{\hyperlink{Cluster_8cc_aca9bff578e68b2d3af09b6bfaa7bd68d}{clus\_it}} it = \mbox{\hyperlink{classCluster_aea7f1c755c1fb744008e344a3692dafb}{conj}}.find(x);}
\DoxyCodeLine{178             \textcolor{keywordtype}{int} aux = it-\/>second.get\_memory(\mbox{\hyperlink{Cpu_8cc_a6249481818bd0eaba64860eec50ca613}{mem}}, identity);}
\DoxyCodeLine{179 }
\DoxyCodeLine{180             \textcolor{keywordflow}{if} (aux != -\/1) \{}
\DoxyCodeLine{181                 \textcolor{keywordtype}{int} aux2 = it-\/>second.space\_left();}
\DoxyCodeLine{182                 \textcolor{keywordflow}{if} (no\_space == -\/1 or aux -\/ \mbox{\hyperlink{Cpu_8cc_a6249481818bd0eaba64860eec50ca613}{mem}} < no\_space or (aux -\/ \mbox{\hyperlink{Cpu_8cc_a6249481818bd0eaba64860eec50ca613}{mem}} == no\_space and aux2 > free\_space)) \{}
\DoxyCodeLine{183                     no\_space = aux -\/ \mbox{\hyperlink{Cpu_8cc_a6249481818bd0eaba64860eec50ca613}{mem}};}
\DoxyCodeLine{184                     free\_space = aux2;}
\DoxyCodeLine{185                     ite = it;}
\DoxyCodeLine{186                 \}}
\DoxyCodeLine{187             \}}
\DoxyCodeLine{188 }
\DoxyCodeLine{189             \textcolor{keywordflow}{if} (!ls.empty()) need\_visit.push(ls);}
\DoxyCodeLine{190             \textcolor{keywordflow}{if} (!rs.empty()) need\_visit.push(rs);}
\DoxyCodeLine{191         \}}
\DoxyCodeLine{192     \}}
\DoxyCodeLine{193 \}}
...
Definition at line 28 of file Cluster.\+cc.


\begin{DoxyCode}{0}
\DoxyCodeLine{28                         \{}
\DoxyCodeLine{29     \mbox{\hyperlink{classCluster_abf5680db313a34a21856e0221453d9c3}{write\_bintree}}(\mbox{\hyperlink{classCluster_a371e399702db6ab3ea1eb21acd625408}{cluster}});}
\DoxyCodeLine{30 \}}
...
Definition at line 78 of file Cluster.\+cc.


\begin{DoxyCode}{0}
\DoxyCodeLine{78                         \{}
\DoxyCodeLine{79     \mbox{\hyperlink{Cluster_8cc_a968d4b1d542c9f666e1a1fbd7f1c9c11}{clus\_ct}} it2 = \mbox{\hyperlink{classCluster_aea7f1c755c1fb744008e344a3692dafb}{conj}}.end();}
\DoxyCodeLine{80 }
\DoxyCodeLine{81     \textcolor{keywordflow}{for} (\mbox{\hyperlink{Cluster_8cc_a968d4b1d542c9f666e1a1fbd7f1c9c11}{clus\_ct}} it = \mbox{\hyperlink{classCluster_aea7f1c755c1fb744008e344a3692dafb}{conj}}.begin(); it != it2; ++it) \{}
\DoxyCodeLine{82         cout << it-\/>first << endl;}
\DoxyCodeLine{83         it-\/>second.write\_cpu();}
\DoxyCodeLine{84     \}}
\DoxyCodeLine{85 \}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{102                                         \{}
\DoxyCodeLine{103     \mbox{\hyperlink{Cluster_8cc_a968d4b1d542c9f666e1a1fbd7f1c9c11}{clus\_ct}} it = \mbox{\hyperlink{classCluster_aea7f1c755c1fb744008e344a3692dafb}{conj}}.find(x);}
\DoxyCodeLine{104     }
\DoxyCodeLine{105     \textcolor{keywordflow}{if} (it == \mbox{\hyperlink{classCluster_aea7f1c755c1fb744008e344a3692dafb}{conj}}.end()) \textcolor{keywordflow}{return} \textcolor{keyword}{false};}
\DoxyCodeLine{106     it-\/>second.write\_cpu();}
...
Definition at line 135 of file Cluster.\+cc.


\begin{DoxyCode}{0}
\DoxyCodeLine{135                         \{}
\DoxyCodeLine{136     \mbox{\hyperlink{Cluster_8cc_a968d4b1d542c9f666e1a1fbd7f1c9c11}{clus\_ct}} it = \mbox{\hyperlink{classCluster_aea7f1c755c1fb744008e344a3692dafb}{conj}}.lower\_bound(x);}
\DoxyCodeLine{137 }
\DoxyCodeLine{138     \textcolor{keywordflow}{if} (it == \mbox{\hyperlink{classCluster_aea7f1c755c1fb744008e344a3692dafb}{conj}}.end() or it-\/>first != x) \textcolor{keywordflow}{return} 101;}
\DoxyCodeLine{139     \textcolor{keywordflow}{if} (!it-\/>second.active\_processes()) \textcolor{keywordflow}{return} 102;}
\DoxyCodeLine{140     \textcolor{keywordflow}{if} (!it-\/>second.yn\_leaf()) \textcolor{keywordflow}{return} 103;}
\DoxyCodeLine{141 }
\DoxyCodeLine{142     \mbox{\hyperlink{classCluster_aea7f1c755c1fb744008e344a3692dafb}{conj}}.erase(it);}
\DoxyCodeLine{143     \mbox{\hyperlink{classCluster_a207680a453088ee7ee51bd05a5050a70}{reread}}(\mbox{\hyperlink{classCluster_a371e399702db6ab3ea1eb21acd625408}{cluster}}, x);}
\DoxyCodeLine{144 }
\DoxyCodeLine{145     \textcolor{keywordflow}{return} 100;}
\DoxyCodeLine{146 \}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{23                    \{}
\DoxyCodeLine{24     \mbox{\hyperlink{classCluster_aea7f1c755c1fb744008e344a3692dafb}{conj}}.clear();}
\DoxyCodeLine{25     \mbox{\hyperlink{classCluster_a0f67ae08ed1bb763f431ba21c4292cc5}{read\_bintree}}(\mbox{\hyperlink{classCluster_a371e399702db6ab3ea1eb21acd625408}{cluster}});}
\DoxyCodeLine{26 \}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{42                                   \{}
\DoxyCodeLine{43     \textcolor{keywordtype}{string} x;}
\DoxyCodeLine{44     cin >> x;}
\DoxyCodeLine{45 }
\DoxyCodeLine{46     \textcolor{keywordflow}{if} (x != \textcolor{stringliteral}{"*"}) \{}
\DoxyCodeLine{47         \textcolor{keywordtype}{int} n;}
\DoxyCodeLine{48         cin >> n;}
\DoxyCodeLine{49         \textcolor{keyword}{auto} it = \mbox{\hyperlink{classCluster_aea7f1c755c1fb744008e344a3692dafb}{conj}}.insert(make\_pair(x, \mbox{\hyperlink{classCpu}{Cpu}}(n)));}
\DoxyCodeLine{50 }
\DoxyCodeLine{51         BinTree<string> left, right;}
\DoxyCodeLine{52         \textcolor{keywordtype}{bool} left\_check = \mbox{\hyperlink{classCluster_a0f67ae08ed1bb763f431ba21c4292cc5}{read\_bintree}}(left);}
\DoxyCodeLine{53         \textcolor{keywordtype}{bool} right\_check = \mbox{\hyperlink{classCluster_a0f67ae08ed1bb763f431ba21c4292cc5}{read\_bintree}}(right);    }
\DoxyCodeLine{54         \textcolor{keywordflow}{if} (left\_check and right\_check) it.first-\/>second.is\_leaf();}
\DoxyCodeLine{55         a = BinTree<string>(x, left, right);}
\DoxyCodeLine{56 }
\DoxyCodeLine{57         \textcolor{keywordflow}{return} \textcolor{keyword}{false};}
\DoxyCodeLine{58     \}}
\DoxyCodeLine{59     \textcolor{keywordflow}{else} \textcolor{keywordflow}{return} \textcolor{keyword}{true};}
\DoxyCodeLine{60 \}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{148                                         \{}
\DoxyCodeLine{149     \textcolor{keywordtype}{int} \mbox{\hyperlink{Cpu_8cc_a6249481818bd0eaba64860eec50ca613}{mem}}, time, id;}
\DoxyCodeLine{150     time = a.\mbox{\hyperlink{classProcess_a35de003f1633c047d70e29265d505b52}{what\_time}}();}
\DoxyCodeLine{151     \textcolor{keywordtype}{id} = a.\mbox{\hyperlink{classProcess_a1c83a78bf269ff88e0ce1b929eee325c}{what\_id}}();}
\DoxyCodeLine{152     \mbox{\hyperlink{Cpu_8cc_a6249481818bd0eaba64860eec50ca613}{mem}} = a.\mbox{\hyperlink{classProcess_a829698b52b61409c211979e86c808065}{what\_mem}}();}
\DoxyCodeLine{153     \mbox{\hyperlink{Cluster_8cc_aca9bff578e68b2d3af09b6bfaa7bd68d}{clus\_it}} ite = \mbox{\hyperlink{classCluster_aea7f1c755c1fb744008e344a3692dafb}{conj}}.end();}
\DoxyCodeLine{154     \mbox{\hyperlink{classCluster_afaff5bd2847c24048b02705e9671da2e}{find\_best}}(\mbox{\hyperlink{Cpu_8cc_a6249481818bd0eaba64860eec50ca613}{mem}}, \textcolor{keywordtype}{id}, ite, \mbox{\hyperlink{classCluster_a371e399702db6ab3ea1eb21acd625408}{cluster}});}
\DoxyCodeLine{155 }
\DoxyCodeLine{156     \textcolor{keywordflow}{if} (ite != \mbox{\hyperlink{classCluster_aea7f1c755c1fb744008e344a3692dafb}{conj}}.end()) \{}
\DoxyCodeLine{157         ite-\/>second.add\_process\_cpu(\textcolor{keywordtype}{id}, \mbox{\hyperlink{Cpu_8cc_a6249481818bd0eaba64860eec50ca613}{mem}}, time);}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{62                                     \{}
\DoxyCodeLine{63     \textcolor{keywordflow}{if} (!a.empty()) \{}
\DoxyCodeLine{64         \textcolor{keywordtype}{string} x = a.value();}
\DoxyCodeLine{65         \textcolor{keywordflow}{if} (x == p) \mbox{\hyperlink{classCluster_a0f67ae08ed1bb763f431ba21c4292cc5}{read\_bintree}}(a);}
\DoxyCodeLine{66         \textcolor{keywordflow}{else} \{}
\DoxyCodeLine{67             BinTree<string> left, right;}
\DoxyCodeLine{68             left = a.left();}
\DoxyCodeLine{69             right = a.right();}
\DoxyCodeLine{70             \mbox{\hyperlink{classCluster_a207680a453088ee7ee51bd05a5050a70}{reread}}(left, p);}
\DoxyCodeLine{71             \mbox{\hyperlink{classCluster_a207680a453088ee7ee51bd05a5050a70}{reread}}(right, p);}
\DoxyCodeLine{72 }
\DoxyCodeLine{73             a = BinTree<string>(x, left, right);}
\DoxyCodeLine{74         \}}
\DoxyCodeLine{75     \}}
\DoxyCodeLine{76 \}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{32                                                 \{}
\DoxyCodeLine{33     \textcolor{keywordflow}{if} (!\mbox{\hyperlink{classCluster_a371e399702db6ab3ea1eb21acd625408}{cluster}}.empty()) \{}
\DoxyCodeLine{34         cout << \textcolor{stringliteral}{"("} << \mbox{\hyperlink{classCluster_a371e399702db6ab3ea1eb21acd625408}{cluster}}.value();}
\DoxyCodeLine{35         \mbox{\hyperlink{classCluster_abf5680db313a34a21856e0221453d9c3}{write\_bintree}}(\mbox{\hyperlink{classCluster_a371e399702db6ab3ea1eb21acd625408}{cluster}}.left());}
\DoxyCodeLine{36         \mbox{\hyperlink{classCluster_abf5680db313a34a21856e0221453d9c3}{write\_bintree}}(\mbox{\hyperlink{classCluster_a371e399702db6ab3ea1eb21acd625408}{cluster}}.right());}
\DoxyCodeLine{37         cout << \textcolor{stringliteral}{")"};}
\DoxyCodeLine{38     \}}
\DoxyCodeLine{39     \textcolor{keywordflow}{else} cout << \textcolor{stringliteral}{" "};}
\DoxyCodeLine{40 \}}
