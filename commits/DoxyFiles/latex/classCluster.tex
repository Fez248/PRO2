...
\begin{DoxyCompactList}\small\item\em Takes the id of a cpu, and the values of a process, checks the errors, and if everything goes right it adds the process to the cpu. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Finds a cpu in the cluster and prints its processes. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Compacts the memory of a cpu. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Receives a process from the waiting area, finds the best cpu for it, if it\textquotesingle{}s possible, it adds the process to the cluster. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
void \mbox{\hyperlink{classCluster_afaff5bd2847c24048b02705e9671da2e}{find\+\_\+best}} (const int \mbox{\hyperlink{Cpu_8cc_a6249481818bd0eaba64860eec50ca613}{mem}}, const int identity, \mbox{\hyperlink{Cluster_8cc_ae1e017a8f236298c12d87027bf00c0e3}{cit}} ite, \mbox{\hyperlink{Cluster_8hh_a8e2ab6d19f821e58db3f5c4f3005937b}{ord\+\_\+ct}} can)
...
Definition at line 197 of file Cluster.\+cc.
...
Takes the id of a cpu, and the values of a process, checks the errors, and if everything goes right it adds the process to the cpu. 

\begin{DoxyPrecond}{Precondition}
All variables initialized. 
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondition}
If the cpu doesn\textquotesingle{}t exist, it returns 101, if not it calls add\+\_\+process\+\_\+cpu and returns the value this function returns, indicating if the process has been successful or not. If so, the process has been added. 
\end{DoxyPostcond}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{175                                                                     \{}
\DoxyCodeLine{176     \mbox{\hyperlink{Cluster_8cc_aca9bff578e68b2d3af09b6bfaa7bd68d}{clus\_it}} it = \mbox{\hyperlink{classCluster_aea7f1c755c1fb744008e344a3692dafb}{conj}}.find(x);}
\DoxyCodeLine{177 }
\DoxyCodeLine{178     \textcolor{keywordflow}{if} (it == \mbox{\hyperlink{classCluster_aea7f1c755c1fb744008e344a3692dafb}{conj}}.end()) \textcolor{keywordflow}{return} 101;}
\DoxyCodeLine{179     \textcolor{keywordflow}{return} it-\/>second.add\_process\_cpu(identity, memory, time);}
\DoxyCodeLine{180 \}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{182                       \{}
\DoxyCodeLine{183     \mbox{\hyperlink{Cluster_8cc_aca9bff578e68b2d3af09b6bfaa7bd68d}{clus\_it}} itf = \mbox{\hyperlink{classCluster_aea7f1c755c1fb744008e344a3692dafb}{conj}}.end();}
\DoxyCodeLine{184 }
\DoxyCodeLine{185     \textcolor{keywordflow}{for} (\mbox{\hyperlink{Cluster_8cc_aca9bff578e68b2d3af09b6bfaa7bd68d}{clus\_it}} it = \mbox{\hyperlink{classCluster_aea7f1c755c1fb744008e344a3692dafb}{conj}}.begin(); it != itf; ++it) it-\/>second.advance(t);}
\DoxyCodeLine{186 \}}
...
Definition at line 167 of file Cluster.\+cc.


\begin{DoxyCode}{0}
\DoxyCodeLine{167                                               \{}
\DoxyCodeLine{168     \mbox{\hyperlink{Cluster_8cc_aca9bff578e68b2d3af09b6bfaa7bd68d}{clus\_it}} it = \mbox{\hyperlink{classCluster_aea7f1c755c1fb744008e344a3692dafb}{conj}}.find(x);}
\DoxyCodeLine{169 }
\DoxyCodeLine{170     \textcolor{keywordflow}{if} (it == \mbox{\hyperlink{classCluster_aea7f1c755c1fb744008e344a3692dafb}{conj}}.end()) \textcolor{keywordflow}{return} 101;}
\DoxyCodeLine{171     \textcolor{keywordtype}{int} back = 0;}
\DoxyCodeLine{172     \textcolor{keywordflow}{return} it-\/>second.remove\_process\_cpu(identity, back);}
\DoxyCodeLine{173 \}}
...
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondition}
All the memory modules from all the cpus have been compacted. 
\end{DoxyPostcond}


Definition at line 141 of file Cluster.\+cc.


\begin{DoxyCode}{0}
\DoxyCodeLine{141                   \{}
\DoxyCodeLine{142     \mbox{\hyperlink{Cluster_8cc_aca9bff578e68b2d3af09b6bfaa7bd68d}{clus\_it}} itf = \mbox{\hyperlink{classCluster_aea7f1c755c1fb744008e344a3692dafb}{conj}}.end();}
\DoxyCodeLine{143     \textcolor{keywordflow}{for} (\mbox{\hyperlink{Cluster_8cc_aca9bff578e68b2d3af09b6bfaa7bd68d}{clus\_it}} it = \mbox{\hyperlink{classCluster_aea7f1c755c1fb744008e344a3692dafb}{conj}}.begin(); it != itf; ++it) \{}
\DoxyCodeLine{144         \textcolor{keywordflow}{if} (it-\/>second.what\_ffree() <= it-\/>second.what\_mema()) \{}
\DoxyCodeLine{145             it-\/>second.compactar();}
\DoxyCodeLine{146         \}}
\DoxyCodeLine{147     \}}
\DoxyCodeLine{148 \}  }
...
Compacts the memory of a cpu. 

\begin{DoxyPrecond}{Precondition}
A cpu id. 
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondition}
If the cpu id doesn\textquotesingle{}t exist, it returns false, if not, it compacts its memory moving all the processes to the beginning of the memory respecting the order and returns true. 
\end{DoxyPostcond}


Definition at line 131 of file Cluster.\+cc.


\begin{DoxyCode}{0}
\DoxyCodeLine{131                           \{}
\DoxyCodeLine{132     \mbox{\hyperlink{Cluster_8cc_aca9bff578e68b2d3af09b6bfaa7bd68d}{clus\_it}} it = \mbox{\hyperlink{classCluster_aea7f1c755c1fb744008e344a3692dafb}{conj}}.find(x);}
\DoxyCodeLine{133 }
\DoxyCodeLine{134     \textcolor{keywordflow}{if} (it == \mbox{\hyperlink{classCluster_aea7f1c755c1fb744008e344a3692dafb}{conj}}.end()) \textcolor{keywordflow}{return} \textcolor{keyword}{false};}
\DoxyCodeLine{135     \textcolor{keywordflow}{if} (it-\/>second.what\_ffree() <= it-\/>second.what\_mema()) \{}
\DoxyCodeLine{136         it-\/>second.compactar();}
\DoxyCodeLine{137     \}}
\DoxyCodeLine{138     \textcolor{keywordflow}{return} \textcolor{keyword}{true};}
\DoxyCodeLine{139 \}}

\end{DoxyCode}
\mbox{\Hypertarget{classCluster_afaff5bd2847c24048b02705e9671da2e}\label{classCluster_afaff5bd2847c24048b02705e9671da2e}} 
...
\begin{DoxyPrecond}{Precondition}
mem, identity, ite and can initialized. 
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondition}
ite points to the best cpu to add the process. 
\end{DoxyPostcond}


Definition at line 25 of file Cluster.\+cc.


\begin{DoxyCode}{0}
\DoxyCodeLine{25                                                                               \{}
\DoxyCodeLine{26     \textcolor{keywordtype}{int} no\_space, free\_space;}
\DoxyCodeLine{27     no\_space = free\_space = -\/1;}
\DoxyCodeLine{28     \textcolor{keywordflow}{if} (!can.empty()) \{}
\DoxyCodeLine{29         queue<BinTree<string>> need\_visit;}
\DoxyCodeLine{30         need\_visit.push(can);}
\DoxyCodeLine{31 }
\DoxyCodeLine{32         \textcolor{keywordflow}{while} (!need\_visit.empty()) \{}
\DoxyCodeLine{33             BinTree<string> ls, rs;}
\DoxyCodeLine{34             ls = need\_visit.front().left();}
\DoxyCodeLine{35             rs = need\_visit.front().right();}
\DoxyCodeLine{36             \textcolor{keywordtype}{string} x = need\_visit.front().value();}
\DoxyCodeLine{37             need\_visit.pop();}
\DoxyCodeLine{38 }
\DoxyCodeLine{39             \mbox{\hyperlink{Cluster_8cc_aca9bff578e68b2d3af09b6bfaa7bd68d}{clus\_it}} it = \mbox{\hyperlink{classCluster_aea7f1c755c1fb744008e344a3692dafb}{conj}}.find(x);}
\DoxyCodeLine{40             \textcolor{keywordtype}{int} aux = it-\/>second.get\_memory(\mbox{\hyperlink{Cpu_8cc_a6249481818bd0eaba64860eec50ca613}{mem}}, identity);}
\DoxyCodeLine{41 }
\DoxyCodeLine{42             \textcolor{keywordflow}{if} (aux != -\/1) \{}
\DoxyCodeLine{43                 \textcolor{keywordtype}{int} aux2 = it-\/>second.space\_left();}
\DoxyCodeLine{44                 \textcolor{keywordflow}{if} (no\_space == -\/1 or aux -\/ \mbox{\hyperlink{Cpu_8cc_a6249481818bd0eaba64860eec50ca613}{mem}} < no\_space or (aux -\/ \mbox{\hyperlink{Cpu_8cc_a6249481818bd0eaba64860eec50ca613}{mem}} == no\_space and aux2 > free\_space)) \{}
\DoxyCodeLine{45                     no\_space = aux -\/ \mbox{\hyperlink{Cpu_8cc_a6249481818bd0eaba64860eec50ca613}{mem}};}
\DoxyCodeLine{46                     free\_space = aux2;}
\DoxyCodeLine{47                     ite = it;}
\DoxyCodeLine{48                 \}}
\DoxyCodeLine{49             \}}
\DoxyCodeLine{50 }
\DoxyCodeLine{51             \textcolor{keywordflow}{if} (!ls.empty()) need\_visit.push(ls);}
\DoxyCodeLine{52             \textcolor{keywordflow}{if} (!rs.empty()) need\_visit.push(rs);}
\DoxyCodeLine{53         \}}
\DoxyCodeLine{54     \}}
\DoxyCodeLine{55 \}}
...
Definition at line 193 of file Cluster.\+cc.


\begin{DoxyCode}{0}
\DoxyCodeLine{193                         \{}
\DoxyCodeLine{194     \mbox{\hyperlink{classCluster_abf5680db313a34a21856e0221453d9c3}{write\_bintree}}(\mbox{\hyperlink{classCluster_a371e399702db6ab3ea1eb21acd625408}{cluster}});}
\DoxyCodeLine{195 \}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{158                         \{}
\DoxyCodeLine{159     \mbox{\hyperlink{Cluster_8cc_a968d4b1d542c9f666e1a1fbd7f1c9c11}{clus\_ct}} it2 = \mbox{\hyperlink{classCluster_aea7f1c755c1fb744008e344a3692dafb}{conj}}.end();}
\DoxyCodeLine{160 }
\DoxyCodeLine{161     \textcolor{keywordflow}{for} (\mbox{\hyperlink{Cluster_8cc_a968d4b1d542c9f666e1a1fbd7f1c9c11}{clus\_ct}} it = \mbox{\hyperlink{classCluster_aea7f1c755c1fb744008e344a3692dafb}{conj}}.begin(); it != it2; ++it) \{}
\DoxyCodeLine{162         cout << it-\/>first << endl;}
\DoxyCodeLine{163         it-\/>second.write\_cpu();}
\DoxyCodeLine{164     \}}
\DoxyCodeLine{165 \}}
...
Finds a cpu in the cluster and prints its processes. 
...
\begin{DoxyCode}{0}
\DoxyCodeLine{150                                         \{}
\DoxyCodeLine{151     \mbox{\hyperlink{Cluster_8cc_a968d4b1d542c9f666e1a1fbd7f1c9c11}{clus\_ct}} it = \mbox{\hyperlink{classCluster_aea7f1c755c1fb744008e344a3692dafb}{conj}}.find(x);}
\DoxyCodeLine{152     }
\DoxyCodeLine{153     \textcolor{keywordflow}{if} (it == \mbox{\hyperlink{classCluster_aea7f1c755c1fb744008e344a3692dafb}{conj}}.end()) \textcolor{keywordflow}{return} \textcolor{keyword}{false};}
\DoxyCodeLine{154     it-\/>second.write\_cpu();}
...
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondition}
If the cpu doesn\textquotesingle{}t exist, it returns 101, if it has any active process it returns 102 and if it has auxiliary cpus it returns 103. If not, it calls \mbox{\hyperlink{classCluster_a207680a453088ee7ee51bd05a5050a70}{reread()}} and returns 100. 
\end{DoxyPostcond}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{108                         \{}
\DoxyCodeLine{109     \mbox{\hyperlink{Cluster_8cc_a968d4b1d542c9f666e1a1fbd7f1c9c11}{clus\_ct}} it = \mbox{\hyperlink{classCluster_aea7f1c755c1fb744008e344a3692dafb}{conj}}.find(x);}
\DoxyCodeLine{110 }
\DoxyCodeLine{111     \textcolor{keywordflow}{if} (it == \mbox{\hyperlink{classCluster_aea7f1c755c1fb744008e344a3692dafb}{conj}}.end()) \textcolor{keywordflow}{return} 101;}
\DoxyCodeLine{112     \textcolor{keywordflow}{if} (!it-\/>second.active\_processes()) \textcolor{keywordflow}{return} 102;}
\DoxyCodeLine{113     \textcolor{keywordflow}{if} (!it-\/>second.yn\_leaf()) \textcolor{keywordflow}{return} 103;}
\DoxyCodeLine{114 }
\DoxyCodeLine{115     \mbox{\hyperlink{classCluster_aea7f1c755c1fb744008e344a3692dafb}{conj}}.erase(it);}
\DoxyCodeLine{116     \mbox{\hyperlink{classCluster_a207680a453088ee7ee51bd05a5050a70}{reread}}(\mbox{\hyperlink{classCluster_a371e399702db6ab3ea1eb21acd625408}{cluster}}, x);}
\DoxyCodeLine{117 }
\DoxyCodeLine{118     \textcolor{keywordflow}{return} 100;}
\DoxyCodeLine{119 \}}
...
Definition at line 188 of file Cluster.\+cc.


\begin{DoxyCode}{0}
\DoxyCodeLine{188                    \{}
\DoxyCodeLine{189     \mbox{\hyperlink{classCluster_aea7f1c755c1fb744008e344a3692dafb}{conj}}.clear();}
\DoxyCodeLine{190     \mbox{\hyperlink{classCluster_a0f67ae08ed1bb763f431ba21c4292cc5}{read\_bintree}}(\mbox{\hyperlink{classCluster_a371e399702db6ab3ea1eb21acd625408}{cluster}});}
\DoxyCodeLine{191 \}}
...
Definition at line 57 of file Cluster.\+cc.


\begin{DoxyCode}{0}
\DoxyCodeLine{57                                 \{}
\DoxyCodeLine{58     \textcolor{keywordtype}{string} x;}
\DoxyCodeLine{59     cin >> x;}
\DoxyCodeLine{60 }
\DoxyCodeLine{61     \textcolor{keywordflow}{if} (x != \textcolor{stringliteral}{"*"}) \{}
\DoxyCodeLine{62         \textcolor{keywordtype}{int} n;}
\DoxyCodeLine{63         cin >> n;}
\DoxyCodeLine{64         \textcolor{keyword}{auto} it = \mbox{\hyperlink{classCluster_aea7f1c755c1fb744008e344a3692dafb}{conj}}.insert(make\_pair(x, \mbox{\hyperlink{classCpu}{Cpu}}(n)));}
\DoxyCodeLine{65 }
\DoxyCodeLine{66         BinTree<string> left, right;}
\DoxyCodeLine{67         \textcolor{keywordtype}{bool} left\_check = \mbox{\hyperlink{classCluster_a0f67ae08ed1bb763f431ba21c4292cc5}{read\_bintree}}(left);}
\DoxyCodeLine{68         \textcolor{keywordtype}{bool} right\_check = \mbox{\hyperlink{classCluster_a0f67ae08ed1bb763f431ba21c4292cc5}{read\_bintree}}(right);    }
\DoxyCodeLine{69         \textcolor{keywordflow}{if} (left\_check and right\_check) it.first-\/>second.is\_leaf();}
\DoxyCodeLine{70         a = BinTree<string>(x, left, right);}
\DoxyCodeLine{71 }
\DoxyCodeLine{72         \textcolor{keywordflow}{return} \textcolor{keyword}{false};}
\DoxyCodeLine{73     \}}
\DoxyCodeLine{74     \textcolor{keywordflow}{else} \textcolor{keywordflow}{return} \textcolor{keyword}{true};}
\DoxyCodeLine{75 \}}
...
Receives a process from the waiting area, finds the best cpu for it, if it\textquotesingle{}s possible, it adds the process to the cluster. 
...
\begin{DoxyCode}{0}
\DoxyCodeLine{93                                         \{}
\DoxyCodeLine{94     \textcolor{keywordtype}{int} \mbox{\hyperlink{Cpu_8cc_a6249481818bd0eaba64860eec50ca613}{mem}}, time, id;}
\DoxyCodeLine{95     time = a.\mbox{\hyperlink{classProcess_a35de003f1633c047d70e29265d505b52}{what\_time}}();}
\DoxyCodeLine{96     \textcolor{keywordtype}{id} = a.\mbox{\hyperlink{classProcess_a1c83a78bf269ff88e0ce1b929eee325c}{what\_id}}();}
\DoxyCodeLine{97     \mbox{\hyperlink{Cpu_8cc_a6249481818bd0eaba64860eec50ca613}{mem}} = a.\mbox{\hyperlink{classProcess_a829698b52b61409c211979e86c808065}{what\_mem}}();}
\DoxyCodeLine{98     \mbox{\hyperlink{Cluster_8cc_aca9bff578e68b2d3af09b6bfaa7bd68d}{clus\_it}} ite = \mbox{\hyperlink{classCluster_aea7f1c755c1fb744008e344a3692dafb}{conj}}.end();}
\DoxyCodeLine{99     \mbox{\hyperlink{classCluster_afaff5bd2847c24048b02705e9671da2e}{find\_best}}(\mbox{\hyperlink{Cpu_8cc_a6249481818bd0eaba64860eec50ca613}{mem}}, \textcolor{keywordtype}{id}, ite, \mbox{\hyperlink{classCluster_a371e399702db6ab3ea1eb21acd625408}{cluster}});}
\DoxyCodeLine{100 }
\DoxyCodeLine{101     \textcolor{keywordflow}{if} (ite != \mbox{\hyperlink{classCluster_aea7f1c755c1fb744008e344a3692dafb}{conj}}.end()) \{}
\DoxyCodeLine{102         ite-\/>second.add\_process\_cpu(\textcolor{keywordtype}{id}, \mbox{\hyperlink{Cpu_8cc_a6249481818bd0eaba64860eec50ca613}{mem}}, time);}
\DoxyCodeLine{103         \textcolor{keywordflow}{return} \textcolor{keyword}{true};}
\DoxyCodeLine{104     \}}
\DoxyCodeLine{105     \textcolor{keywordflow}{else} \textcolor{keywordflow}{return} \textcolor{keyword}{false};}
\DoxyCodeLine{106 \}}
...
\begin{DoxyPrecond}{Precondition}
The new cluster ready to be read on the console, a initialized and guaranteed that p exists, it doesn\textquotesingle{}t have processes and it\textquotesingle{}s a leaf of the tree and p initialized. 
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondition}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{77                                     \{}
\DoxyCodeLine{78     \textcolor{keywordflow}{if} (!a.empty()) \{}
\DoxyCodeLine{79         \textcolor{keywordtype}{string} x = a.value();}
\DoxyCodeLine{80         \textcolor{keywordflow}{if} (x == p) \mbox{\hyperlink{classCluster_a0f67ae08ed1bb763f431ba21c4292cc5}{read\_bintree}}(a);}
\DoxyCodeLine{81         \textcolor{keywordflow}{else} \{}
\DoxyCodeLine{82             BinTree<string> left, right;}
\DoxyCodeLine{83             left = a.left();}
\DoxyCodeLine{84             right = a.right();}
\DoxyCodeLine{85             \mbox{\hyperlink{classCluster_a207680a453088ee7ee51bd05a5050a70}{reread}}(left, p);}
\DoxyCodeLine{86             \mbox{\hyperlink{classCluster_a207680a453088ee7ee51bd05a5050a70}{reread}}(right, p);}
\DoxyCodeLine{87 }
\DoxyCodeLine{88             a = BinTree<string>(x, left, right);}
\DoxyCodeLine{89         \}}
\DoxyCodeLine{90     \}}
\DoxyCodeLine{91 \}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{121                                                 \{}
\DoxyCodeLine{122     \textcolor{keywordflow}{if} (!\mbox{\hyperlink{classCluster_a371e399702db6ab3ea1eb21acd625408}{cluster}}.empty()) \{}
\DoxyCodeLine{123         cout << \textcolor{stringliteral}{"("} << \mbox{\hyperlink{classCluster_a371e399702db6ab3ea1eb21acd625408}{cluster}}.value();}
\DoxyCodeLine{124         \mbox{\hyperlink{classCluster_abf5680db313a34a21856e0221453d9c3}{write\_bintree}}(\mbox{\hyperlink{classCluster_a371e399702db6ab3ea1eb21acd625408}{cluster}}.left());}
\DoxyCodeLine{125         \mbox{\hyperlink{classCluster_abf5680db313a34a21856e0221453d9c3}{write\_bintree}}(\mbox{\hyperlink{classCluster_a371e399702db6ab3ea1eb21acd625408}{cluster}}.right());}
\DoxyCodeLine{126         cout << \textcolor{stringliteral}{")"};}
\DoxyCodeLine{127     \}}
\DoxyCodeLine{128     \textcolor{keywordflow}{else} cout << \textcolor{stringliteral}{" "};}
\DoxyCodeLine{129 \}}
...
Definition at line 29 of file Cluster.\+hh.
